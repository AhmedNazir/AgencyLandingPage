...
import FigmaLogo from "../assets/icons/FigmaLogo";
import GitHubLogo from "../assets/icons/GithubLogo";

export default function HeroSection() {
    const heroSectionTitleLine1 = "Building digital";
    const heroSectionTitleLine2 = "products & brands.";
                ...
                <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        ...
                        <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                            ...
                            and based on the components from the Flowbite
                            Library and the Blocks System.
                        </p>
