export default function TrialSection() {
    const trialHeading = "Start your free trial today";
    const trialDays = 30;
    const details = `Try Landwind Platform for ${trialDays} days. No credit card required.`;
    const btnText = `Free trial for ${trialDays} days`;
    const btnLink = "#";
